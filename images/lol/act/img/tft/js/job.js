module.exports=
{
	...
	"data": [
		...
		},
		{
			...
			"name": "刺客",
			"traitId": "3",
			"introduce": "固有：在战斗环节开始时，刺客会移动到敌人的后排。\r\n刺客在战斗环节开始时获得持续6秒的攻击速度加成。\r\n所有层级的攻击速度加成都会在参与击杀后刷新\r\n在战斗环节开始时，【刺客】们无论攻击距离内有无目标，都会跳到敌方后排。",
			"alias": "3003.png",
			"level": {
				"2": "40%额外攻击速度",
				"4": "80%额外攻击速度，参与击杀后刷新",
		...
		},
		{
			...
			"name": "狙神",
			"traitId": "7",
			"introduce": "【狙神】与目标之间每相距1格，造成的伤害就会获得一定提升。",
			"alias": "3007.png",
			"level": {
				"2": "【狙神】与目标之间每相距1格，造成的伤害就会提升10%。",
				"4": "【狙神】与目标之间每相距1格，造成的伤害就会提升18%。"
			},
			"TFTID": "30",
		...
		},
		{
			...
			"name": "破法战士",
			"traitId": "9",
			"introduce": "【破法战士】们的普通攻击会使目标下一个技能的法力消耗提升40%。移除了【破法战士】4英雄羁绊加成。",
			"alias": "3009.png",
			"level": {
				"2": "【破法战士】们的普通攻击会使目标下一个技能的法力消耗提升40%。"
			},
			"TFTID": "32",
		...
		},
		{
			...
			"name": "强袭枪手",
			"traitId": "10",
			"introduce": "每个强袭枪手的每第四次攻击会朝着随机敌人发射若干次额外攻击。\r\n这些额外的攻击会像普通攻击一样造成伤害并触发攻击特效。",
			"alias": "3010.png",
			"level": {
				"2": "3次额外攻击",
				"4": "6次额外攻击"
		...
		},
		{
			...
			"name": "星舰龙神",
			"traitId": "11",
			"introduce": "固有：【星舰】每秒获得40法力值，围着棋盘不断回旋，并且免疫移动受损效果，但无法进行普通攻击。",
			"alias": "3011.png",
			"level": {
				"1": "固有：【星舰】每秒获得40法力值，围着棋盘不断回旋，并且免疫移动受损效果，但无法进行普通攻击。"
			},
			"TFTID": "34",
		...
		},
		{
			...
			"name": "大魔法使",
			"traitId": "14",
			"introduce": "友方【星之守护者】 的普通攻击转化为真实伤害。所有其他友军的普通攻击转化为魔法伤害。\r\n",
			"alias": "3014.png",
			"level": {
				"1": "友方【星之守护者】 的普通攻击转化为真实伤害。所有其他友军的普通攻击转化为魔法伤害。\r\n"
			},
			"TFTID": "37",
			"imagePath": "https://game.gtimg.cn/images/lol/act/img/tft/classes/3014.png"
		}
	]
}